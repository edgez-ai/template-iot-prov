...
const required = {
  ...
  NEXT_PUBLIC_DATABASE_ID: process.env.IOT_PROV_DATABASE_ID || localResources.databaseId,
  NEXT_PUBLIC_TELEMETRY_TABLE_ID:
    process.env.IOT_PROV_TELEMETRY_TABLE_ID || localResources.telemetryTableId,
};
